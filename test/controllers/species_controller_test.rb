...
class SpeciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create species" do
    assert_difference('Species.count') do
      post species_index_url, params: { species: { description: @species.description, name: @species.name, picture: @species.picture } }
    end
  ...
  test "should update species" do
    patch species_url(@species), params: { species: { description: @species.description, name: @species.name, picture: @species.picture } }
