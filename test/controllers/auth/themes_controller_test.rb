...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { title: 'NewTitle', description: 'NewDescription' } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { description: @theme.description, title: @theme.title } }
    assert_response :success
  end
