...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { action_id: @cost.action_id, title: @cost.title, unit: @cost.unit, value_max: @cost.value_max, value_min: @cost.value_min } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { action_id: @cost.action_id, title: @cost.title, unit: @cost.unit, value_max: @cost.value_max, value_min: @cost.value_min } }
