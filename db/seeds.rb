...
welcomeHedgehogs = Action.create!(
  ...
  surface_min: 1.0,
  investment: 1,
  picture: 'photo_accueillir_herissons.jpg',
...
simpleLayouts = Action.create!(
  ...
  surface_min: 1.0,
  investment: 2,
  picture: 'photo_amenagements_simples.gif',
...
hedgehogHouse = Action.create!(
  ...
  surface_min: 3.0,
  investment: 3,
  picture: 'photo_abri_a_herissons.png',
...
discoverMeadows = Action.create!(
  ...
  surface_min: 0.0,
  investment: 1,
  picture: 'photo_decouvrir_les_prairies.jpeg',
...
diffMaintenance = Action.create!(
  ...
  surface_min: 10.0,
  investment: 2,
  picture: 'photo_entretien_differencie.jpg',
...
createMeadow = Action.create!(
  ...
  surface_min: 10.0,
  investment: 3,
  picture: 'photo_amenager_une_prairie_fleurie.png',
...
task1 = Task.create!(
  ...
  short_description: 'Description succincte de **visiter une prairie fleurie exemplaire**',
  constraint_time: 'Contrainte durée **visite prairie fleurie**',
  constraint_task: 'Contrainte tâche **visite prairie fleurie**',
...
task2 = Task.create!(
  ...
  short_description: 'Description succincte de **informer sur écologie** de ce type de milieu',
  constraint_time: 'Contrainte durée **informer sur écologie**',
  constraint_task: 'Contrainte tâche **informer sur écologie**',
...
task3 = Task.create!(
  ...
  short_description: 'Description succincte de **adapter entretien de son gazon**',
  constraint_time: 'Contrainte durée **adapter entretien de son gazon**',
  constraint_task: 'Contrainte tâche **adapter entretien de son gazon**',
...
task5 = Task.create!(
  ...
  short_description: 'Description succincte de **choisir un emplacement**',
  action: createMeadow)
...
task6 = Task.create!(
  ...
  short_description: 'Description succincte de **choisir une mélange grainier**',
  action: createMeadow)
...
task7 = Task.create!(
  ...
  short_description: 'Description succincte de **préparer le sol**',
  action: createMeadow)
...
task8 = Task.create!(
  ...
  short_description: 'Description succincte de **semer**',
  action: createMeadow)
...
task9 = Task.create!(
  ...
  short_description: 'Description succincte de **passer avec un rouleau**',
  action: createMeadow)
...
task10 = Task.create!(
  ...
  short_description: 'Description succincte de **entretenir le semis la première année**',
  action: createMeadow)
...
task11 = Task.create!(
  ...
  short_description: 'Description succincte de **entretenir le semis les années suivantes**',
  action: createMeadow)
