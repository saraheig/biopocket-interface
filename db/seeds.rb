...
Work.create!(
    ...
    impact: 'Un entretien différencie encourage la biodiversité au sein de son gazon.',
    house: true,
    cost: 0.0,
    time: '3h00',
    difficulty: 2)
...
Work.create!(
    ...
    impact: 'Les priaries fleuries constituent des habitats pour la petite faune et des lieux de nourrissage (insectes, oiseaux, mammifères).',
    house: true,
    cost: 30.0,
    time: '4h00',
    difficulty: 3)
