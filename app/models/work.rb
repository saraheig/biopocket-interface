class Work < ApplicationRecord
  ...
  validates_format_of :cost, :with => /\A[1-9][0-9]*\.?[0-9]?[0|5]?\z/, :message => "Le coût doit être présent et être un nombre qui peut contenir deux décimales (facultatif), dont la deuxième a la valeur de 0 ou 5."
