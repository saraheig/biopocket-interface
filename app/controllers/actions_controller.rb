class ActionsController < AuthenticateController
  ...
  private
    ...
    def action_params
      params.require(:bioaction).permit(:theme_id, :type_id, :title, :description, :impact, :spot, :cost_min, :time_min, :time_unit, :time_description, :surface_min, :investment, :picture, :load_picture, :importance)
    end
end